...
const HeadInfoCard1 = ({ pfp, por, name, degree, phno }) => {
    return (
        <div className="w-full bg-black flex flex-row my-4">
            <div className="w-1/3 h-40 md:h-72 md:w-1/5 flex justify-center items-center rounded-xl md:rounded-2xl overflow-hidden bg-gradient-to-b from-teambg1">
                <Image src={pfp} height={200} width={200} className="object-contain w-full h-full object-center rounded-xl md:rounded-2xl" unoptimized/>
            </div>
