...
const LandingCard1 = () => { 
    return (
        <div className="group w-4/5 sm:w-3/4 md:w-full lg:w-full bg-gradient-45 from-gradbluedark to-gradbluelight rounded-3xl overflow-hidden flex flex-col m-0 hover:opacity-75 transition-all duration-300 hover:cursor-pointer">
