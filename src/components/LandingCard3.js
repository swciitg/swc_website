...
const LandingCard3 = () => { 
    return (
        <Link  href='/cards/apk/College_Cupid.apk' download={true} className="group w-4/5 sm:w-3/4 md:w-full lg:w-full bg-gradient-45 from-gradgreendark to-gradgreenlight rounded-3xl overflow-hidden flex flex-col m-0 hover:opacity-50 transition-all duration-300 hover:cursor-pointer">
